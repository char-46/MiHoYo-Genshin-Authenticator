...
//    val worldExplorations: List<WorldExploration> = emptyList()
    ...
    data class Stats(/*@SerializedName("achievement_number")
        ...
        val domainNumber: Int = -1,*/
                     @SerializedName("anemoculus_number") val anemoculusNumber: Int = -1,
                     @SerializedName("geoculus_number") val geoculusNumber: Int = -1,
                     @SerializedName("electroculus_number") val electroculusNumber: Int = -1,
                     @SerializedName("common_chest_number") val commonChestNumber: Int = -1,
                     @SerializedName("exquisite_chest_number") val exquisiteChestNumber: Int = -1,
                     @SerializedName("precious_chest_number") val preciousChestNumber: Int = -1,
                     @SerializedName("luxurious_chest_number") val luxuriousChestNumber: Int = -1,
                     @SerializedName("magic_chest_number") val magicChestNumber: Int = -1,
                     @SerializedName("dendroculus_number") val dendroculus_number: Int = -1
    )
