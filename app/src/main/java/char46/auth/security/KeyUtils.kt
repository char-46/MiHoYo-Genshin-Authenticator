...
private fun generateSecretKey(
    keystoreAlias: String, purposes: Int, parameterBuilder: KeyGenParameterSpec.Builder.() -> Unit
...
fun X509EncodedKeySpec.toPublicKey(): PublicKey = KeyFactory.getInstance("RSA").generatePublic(this)
